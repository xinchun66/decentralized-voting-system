...
import ResultPublicityPanel from "./ResultPublicityPanel.jsx";
        ...
        >
          ...
          <section style={{ marginBottom: 15 }}>
            <header style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
              <span style={{ color: "#16a34a", fontWeight: 600 }}>同意</span>
              <span style={{ color: "#334155" }}>
                {yes} 票权 · {rates.yesRate}%
              </span>
            </header>
            <section style={{ height: 12, background: "#e2e8f0", borderRadius: 6, overflow: "hidden" }}>
              <section
                style={{
                  height: "100%",
                  width: `${rates.yesNum || 0}%`,
                  minWidth: yes > 0 ? "4px" : 0,
                  background: "#22c55e",
          ...
          <section style={{ marginBottom: 15 }}>
            <header style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
              <span style={{ color: "#dc2626", fontWeight: 600 }}>不同意</span>
              <span style={{ color: "#334155" }}>
                {no} 票权 · {rates.noRate}%
              </span>
            </header>
